#ifndef HNRIBBONTOOLBUTTON_H
#define HNRIBBONTOOLBUTTON_H
#include "hnQTRibbonGlobal.h"
#include <QToolButton>
///
/// \brief Ribbon界面适用的toolButton
///
class HN_QTRIBBON_EXPORT hnRibbonToolButton : public QToolButton
{
    Q_OBJECT
...
public:
	...
	hnRibbonToolButton(QWidget *parent = Q_NULLPTR);
	hnRibbonToolButton(QAction* defaultAction,QWidget *parent = Q_NULLPTR);
